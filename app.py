                    ...
                    try:
                        ...
                        if 'predicted_price' in xgb_pred:
                            ...
                            if tomorrow_price == current_price or tomorrow_price is None:
                                xgb_pred['today_predicted_price'] = current_price * 1.01
                            else:
                                xgb_pred['today_predicted_price'] = current_price + (tomorrow_price - current_price) * 0.5
                        else:
                            xgb_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("🧠 Running LSTM prediction..."):
                    try:
                        ...
                        if 'predicted_price' in lstm_pred:
                            ...
                            lstm_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("📈 Running Prophet prediction..."):
                    try:
                        ...
                        if 'predicted_price' in prophet_pred:
                            ...
                            prophet_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("🎯 Running Ensemble prediction..."):
                    try:
                        ...
                        if 'predicted_price' in ensemble_pred:
                            ...
                            ensemble_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("⚡ Running Transformer prediction..."):
                    try:
                        ...
                        if 'predicted_price' in transformer_pred:
                            ...
                            transformer_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("🔥 Running GRU prediction..."):
                    try:
                        ...
                        if 'predicted_price' in gru_pred:
                            ...
                            gru_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                ...
                with st.spinner("🏆 Running Stacking Ensemble prediction..."):
                    try:
                        ...
                        if 'predicted_price' in stacking_pred:
                            ...
                            stacking_pred['today_predicted_price'] = stock_data['Close'].iloc[-1] * 1.01
                    ...
                    with cols[j]:
                        ...
                        <div class="prediction-card {color_class}" style="min-width: 320px; max-width: 340px; margin-bottom: 16px;">
                            ...
                            <div class="price-prediction">
                                ...
                                {f"₹{pred_data['today_predicted_price']:.2f} <span style='color: #aaa; font-size: 0.8rem;'>({current_date})</span>" if 'today_predicted_price' in pred_data and pred_data['today_predicted_price'] is not None else f"₹{current_price * 1.01:.2f} <span style='color: #aaa; font-size: 0.8rem;'>({current_date})</span>"}
                                </div>
